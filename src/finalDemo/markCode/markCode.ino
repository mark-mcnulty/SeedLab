...
volatile float Kp = 2.7; // best 2.9
volatile float Ki = 3.0; // best 3.0
volatile float I = 0.00;

volatile float Kp_slave = 3.3; //best 2.7  2.5 
volatile float Ki_slave = 1.1; // formerly 1.1
volatile float I_slave = 0.00;

volatile float windUpTolerance = PI/2;         //PI/2.3
volatile int MAX_PWM = 175;
